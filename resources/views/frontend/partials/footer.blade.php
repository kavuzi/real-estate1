<footer class="page-footer indigo darken-2">
    <div class="container">
        <div class="row">
            <div class="col m4 s12">
                <h5 class="white-text lowercase">About Us</h5>
                @if(isset($footersettings[0]) && $footersettings[0]['aboutus'])
                    <p class="grey-text text-lighten-4">{{ $footersettings[0]['aboutus'] }}</p>
                @else
                    <p class="grey-text text-lighten-4">E-housing is a  commercial real estate online, which provides a full suite of the most heavily trafficked sites for office, industrial, retail, apartments, and homes for Sale.</p>
                @endif
            </div>
            <div class="col m6 s12">
                <h5 class="white-text lowercase">Recent Properties</h5>
            ...
            <div class="col m2 s12">
                <h5 class="white-text lowercase">Quick Links</h5>
                <ul>
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            @else
                © 2020 kavuzitech||E-housing.com all rights reserved.
            @endif
